...
import { FindAllProductQuery, FindAllProductQueryResult } from "./find-all-product.query";

@QueryHandler(FindAllProductQuery)
export class FindAllProductQueryHandler implements IQueryHandler<FindAllProductQuery> {
